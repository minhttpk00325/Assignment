...
Public Class Loai
    ...
    Private Sub loaddata()
        abc.Open()
        Dim load As New SqlCommand("select * from Loai", abc)
        ...
        Next
    End Sub
    Private Sub Loai_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loaddata()
    End Sub

    Private Sub Loai_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub bntthem_Click(sender As Object, e As EventArgs) Handles bntthem.Click
        If (KiemTraThongTin() = True) Then
            Try
                ...
                Dim them As New SqlCommand("Insert into Loai(idloaisp,tenloaisp,mota) values('" + idloaisp + "' , N'" + tenloaisp + "',N'" + mota + "')", abc)
    ...
    Private Sub bntxoa_Click(sender As Object, e As EventArgs) Handles bntxoa.Click
        Try
            abc.Open()
            Dim idloaisp As String = txt_idloaisp.Text
            Dim xoa As New SqlCommand("delete from Loai where idloaisp ='" + idloaisp + "'", abc)
            xoa.ExecuteNonQuery()
            abc.Close()
    ...
    Private Sub bntsua_Click(sender As Object, e As EventArgs) Handles bntsua.Click
        Try
            ...
            Dim sua As New SqlCommand("update Loai set   tenloaisp = '" + tenloaisp + "',  mota = '" + mota + "' where idloaisp = '" + idloaisp + "' ", abc)
            sua.ExecuteNonQuery()
            abc.Close()
